...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    //When app runs allow all requested permissions through
    //Make sure emulator has location services enabled
    ...
    private void initMap(){
        ...
        if(mGeoApiContext == null){
            ...
            mGeoApiContext.setApiKey(getString(R.string.google_maps_API_key));
        }
    }
    ...
    private void getLocationPermission(){
        ...
        if(ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            if(ContextCompat.checkSelfPermission(this.getApplicationContext(),
                ...
                Toast.makeText(this, "initMap in getLocationPermission", Toast.LENGTH_LONG).show();
            }
        }
        else{
        ...
        switch(requestCode){
            case LOCATION_PERMISSION_REQUEST_CODE:
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    checkPermissions = true;
                    initMap();
                    Toast.makeText(this, "initMap in RequestPermissionsResult", Toast.LENGTH_SHORT).show();
                }
        }
        initMap();
